...
- [ ] Enemies / hazards (spikes, patrols)
- [ ] Moving platforms
- [ ] Collectible power-ups (double jump, speed boost)
- [ ] Level editor (in-app)
- [ ] Sound effects (terminal bell / OSC sequences)
- [ ] Leaderboard / time trial
- [ ] Procedurally generated endless mode
- [ ] Controller support (arrow keys + space)
